...
variants=(
  ifsa_v27_scale_tau0p5_hold0p5_disc0p001_sh0p05
  ifsa_v27_scale_tau0p5_hold0p5_disc0p001_sh0p10
  ifsa_v27_trnorm_scale_tau0p5_hold0p5_disc0p001_sh0p10
)

for v in "${variants[@]}"; do
  "${RUN_TMUX}" "${HOST}" "ifsa_roundQ__${v}__2a__trans" \
  ...
  "${RUN_TMUX}" "${HOST}" "ifsa_roundQ__${v}__2b__online" \
