...
variants=(
  ifsa_v25_track_scale_tau0p47_hold0p5_disc0p001
  ifsa_v25_track_scale_tau0p49_hold0p5_disc0p001
  ifsa_v25_track_scale_tau0p51_hold0p5_disc0p001
  ifsa_v25_track_scale_tau0p53_hold0p5_disc0p001
)

for v in "${variants[@]}"; do
  "${RUN_TMUX}" "${HOST}" "ifsa_roundO__${v}__2a__trans" \
  ...
  "${RUN_TMUX}" "${HOST}" "ifsa_roundO__${v}__2b__online" \
