...
variants=(
  ifsa_v13_tg_beta1_full_u0p05
  ifsa_v13_tg_beta1_full_spec0p2
  ifsa_v13_tg_beta1_full_spec0p2_u0p05
  ifsa_v13_tg_beta1_full_gain0p9
)

for v in "${variants[@]}"; do
  "${RUN_TMUX}" "${HOST}" "ifsa_reg__${v}__2a__trans" \
  ...
  "${RUN_TMUX}" "${HOST}" "ifsa_reg__${v}__2b__online" \
