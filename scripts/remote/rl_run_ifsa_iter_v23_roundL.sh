...
variants=(
  ifsa_v23_track_scale_tau0p5_hold0p5_disc0p001
  ifsa_v23_track_scale_tau0p5_hold0p6_disc0p001
)

for v in "${variants[@]}"; do
  "${RUN_TMUX}" "${HOST}" "ifsa_roundL__${v}__2a__trans" \
  ...
  "${RUN_TMUX}" "${HOST}" "ifsa_roundL__${v}__2b__online" \
